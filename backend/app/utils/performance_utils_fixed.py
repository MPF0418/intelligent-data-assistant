        ...
        def wrapper(*args, **kwargs):
            ...
            for arg in args:
                try:
                    ...
                    cacheable_args.append(str(type(arg)))
            ...
            for key, value in kwargs.items():
                try:
                    ...
                    cacheable_kwargs[key] = str(type(value))
            
            key = cache_manager._generate_key(func.__name__, tuple(cacheable_args), cacheable_kwargs)
